  ...
  return (
    <Header menuItems={items}>
      ...
      <Header.Main
        ...
        inverted={isHomePath ? true : isHomePageInverse ? true : false}
        transparency={isHomePath ? true : isHomePageInverse ? true : false}
        logo={
          <div {...(isSubsite ? { className: 'logo-wrapper' } : {})}>
            <Logo
              src={
                isHomePath ? logoWhite : isHomePageInverse ? logoWhite : logo
              }
